...
This iOS sample app is a real-device debugging companion for ArcBLEKit. It focuses on the Task 4 workflow:
...
8. Stop and relaunch the app.
9. Tap **Reconnect Saved Device**.
...
- The log shows scan, connect, reconnect, disconnect, and connection state transitions.
